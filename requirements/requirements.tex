...
The user will also be able to see all of this data at an individual investment level. This means that there should be 
time data, Sharpe ratio, volatility, and benchmarks of individual investments, when relevant/available.
...
\begin{itemize}
	...
	\item Users must be able to enter data through the application in two formats. First, one investment at a time manually added in using the user-friendly interface. Second,
		adding a CSV file or EXCEL file containing the user's portfolio data to the application and it will automatically populate the user's profile based off the file.
