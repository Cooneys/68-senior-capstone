	...
	\begin{table}[h]
                        \caption{Table 1 - Summary of Design Viewpoints}
                                \begin{tabular}{| p{0.3\linewidth} | p{0.3\linewidth} | p{0.3\linewidth} | }
                                        ...
                                        \hline
                                        Requirements document properly revised and resubmitted after client drop off & Finish revision of project proposal and begin technology review planning & Have a group meeting to work on revisions and plan for the upcoming document\\
                                        \hline
